...
--changeset SYSTEM:Business_Partner_Service_Area runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_LOYALTY;

create or replace TABLE BUSINESS_PARTNER_SERVICE_AREA (
	...
	SERVICE_AREA_TYPE_CD VARCHAR(50) NOT NULL COMMENT 'Service_Area_Type_Cd',
	...
	SERVICE_AREA_DSC VARCHAR(250) COMMENT 'Service_Area_Dsc',
	SERVICE_AREA_SHORT_DSC VARCHAR(50) COMMENT 'Service_Area_Short_Dsc',
	...
	primary key (BUSINESS_PARTNER_INTEGRATION_ID, PARTNER_NM, SERVICE_AREA_TYPE_CD, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
