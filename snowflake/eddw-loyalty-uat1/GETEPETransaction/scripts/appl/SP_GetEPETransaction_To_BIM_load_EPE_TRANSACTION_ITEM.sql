...
--changeset SYSTEM:SP_GetEPETransaction_To_BIM_load_EPE_TRANSACTION_ITEM runOnChange:true splitStatements:false OBJECT_TYPE:SP
use database EDM_CONFIRMED_PRD;
use schema EDM_CONFIRMED_PRD.DW_APPL;

CREATE OR REPLACE PROCEDURE SP_GetEPETransaction_To_BIM_load_EPE_TRANSACTION_ITEM(SRC_WRK_TBL VARCHAR, CNF_DB VARCHAR,C_RETAIL VARCHAR, C_STAGE VARCHAR)
RETURNS STRING
LANGUAGE JAVASCRIPT
AS 
$$
