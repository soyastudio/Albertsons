...
--changeset SYSTEM:SP_GetEPETransaction_To_BIM_load_EPE_Transaction_Item_Savings runOnChange:true splitStatements:false OBJECT_TYPE:SP
use database <<EDM_DB_NAME>>;
use schema DW_APPL;

CREATE OR REPLACE PROCEDURE SP_GETEPETRANSACTION_TO_BIM_LOAD_EPE_TRANSACTION_ITEM_SAVINGS
