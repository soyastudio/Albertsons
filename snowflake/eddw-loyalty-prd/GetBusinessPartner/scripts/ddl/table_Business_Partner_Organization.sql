...
--changeset SYSTEM:Business_Partner_Organization runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_LOYALTY;

create or replace TABLE BUSINESS_PARTNER_ORGANIZATION (
	...
	ORGANIZATION_TYPE_CD VARCHAR(50) NOT NULL COMMENT 'Organization_Type_Cd',
	...
	ORGANIZATION_VALUE_TXT VARCHAR(50) COMMENT 'Organization_Value_Txt',
	...
	primary key (BUSINESS_PARTNER_INTEGRATION_ID, PARTNER_NM, ORGANIZATION_TYPE_CD, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
