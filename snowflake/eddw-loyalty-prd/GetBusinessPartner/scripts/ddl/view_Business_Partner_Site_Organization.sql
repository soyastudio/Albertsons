...
--changeset SYSTEM:Business_Partner_Site_Organization runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view BUSINESS_PARTNER_SITE_ORGANIZATION(
	BUSINESS_PARTNER_INTEGRATION_ID COMMENT 'Business Partner Integration Id',
	PARTNER_SITE_ORGANIZATION_TYPE_CD COMMENT 'Partner Site Organization Type Cd',
	DW_FIRST_EFFECTIVE_DT COMMENT 'DW First Effective Date',
	DW_LAST_EFFECTIVE_DT COMMENT 'DW Last Effective Date',
	PARTNER_SITE_ORGANIZATION_VALUE_TXT COMMENT 'Partner Site Organization Value Txt',
...
) COMMENT='VIEW for Business_Partner_Site_Organization'
 as
select
...
from <<EDM_DB_NAME>>.DW_C_LOYALTY.Business_Partner_Site_Organization;
