...
--changeset SYSTEM:EPE_Transaction_Error runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_RETAILSALE;

create or replace TABLE EPE_TRANSACTION_ERROR (
	...
	PRICING_ERROR_CD VARCHAR(16777216) NOT NULL COMMENT 'Error Name',
	...
	PRICING_ERROR_DSC VARCHAR(16777216) COMMENT 'Error Description',
	...
	primary key (TRANSACTION_INTEGRATION_ID, UPC_NBR, PRICING_ERROR_CD, DW_LAST_EFFECTIVE_DT, DW_FIRST_EFFECTIVE_DT)
);
