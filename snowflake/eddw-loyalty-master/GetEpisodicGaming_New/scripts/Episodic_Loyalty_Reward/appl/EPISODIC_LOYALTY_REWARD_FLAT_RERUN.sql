...
--changeset SYSTEM:EPISODIC_LOYALTY_REWARD_FLAT_RERUN runOnChange:true splitStatements:false OBJECT_TYPE:TABLE

USE DATABASE <<EDM_DB_NAME>>;
USE SCHEMA <<EDM_DB_NAME>>.DW_C_STAGE;

CREATE OR REPLACE TABLE EPISODIC_LOYALTY_REWARD_FLAT_RERUN(
