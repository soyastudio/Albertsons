...
CREATE OR REPLACE TABLE EPISODIC_FRESHPASS_ISSUANCE
(
	Program_Id VARCHAR NOT NULL  COMMENT 'Unique Identifier of the episodic program',
	Freshpass_Issuance_Id NUMBER NOT NULL  COMMENT 'Unique transaction identifier for each freshpass issuance',
	...
	Division_Nm VARCHAR NULL  COMMENT 'Users default division',
	...
	Retail_Store_Id VARCHAR NULL  COMMENT 'Identifier of user''s preferred store ',
	...
	Extract_Ts TIMESTAMP NULL  COMMENT 'Timestamp when the record has been queried',
...
ALTER TABLE EPISODIC_FRESHPASS_ISSUANCE
	ADD CONSTRAINT XPKepisodic_Freshpass_issuance PRIMARY KEY (Program_Id, Freshpass_Issuance_Id, Dw_First_Effective_Dt, Dw_Last_Effective_Dt);
