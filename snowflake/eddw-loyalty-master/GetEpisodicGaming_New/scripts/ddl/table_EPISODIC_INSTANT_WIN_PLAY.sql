...
--changeset SYSTEM:EPISODIC_INSTANT_WIN_PLAY runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_LOYALTY;

create or replace TABLE EPISODIC_INSTANT_WIN_PLAY (
	PROGRAM_ID VARCHAR(16777216) NOT NULL COMMENT 'Albertson''s program identifier.',
	PLAY_ID NUMBER(38,0) NOT NULL COMMENT 'Unique identifier.',
	HOUSEHOLD_ID NUMBER(38,0) COMMENT 'Household ID.',
	GAME_UUID VARCHAR(16777216) COMMENT 'Game played.',
	PLAY_DT TIMESTAMP_LTZ(9) COMMENT 'The Time of game play.',
	...
	primary key (PROGRAM_ID, PLAY_ID, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
