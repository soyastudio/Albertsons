...
--changeset SYSTEM:EPISODIC_GAME runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view EPISODIC_GAME(
	PROGRAM_ID COMMENT 'TAlbertsons program identifier.',
	GAME_UUID COMMENT 'Unique game identifier.',
	GAME_NM COMMENT 'Game name.',
...
) COMMENT='VIEW for Episodic_Game'
 as
select 
Program_Id,            
Game_Uuid,            
...
from EDM_CONFIRMED_PRD.DW_C_LOYALTY.Episodic_Game;
