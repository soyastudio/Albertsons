...
--changeset SYSTEM:EPISODIC_PROGRAM runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_LOYALTY;

create or replace TABLE EPISODIC_PROGRAM (
	PROGRAM_ID VARCHAR(16777216) NOT NULL COMMENT 'Unique program id.',
	PROGRAM_NM VARCHAR(16777216) COMMENT 'Program Name.',
	PROGRAM_LABEL_NM VARCHAR(16777216) COMMENT 'Program Label Name.',
	MERKLE_PROMO_ID NUMBER(38,0) COMMENT 'Merke''s internal promotion id.',
	START_DT TIMESTAMP_LTZ(9) COMMENT 'The start date of the program.',
	END_DT TIMESTAMP_LTZ(9) COMMENT 'The end date of the program.',
	...
	primary key (PROGRAM_ID, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
