...
--changeset SYSTEM:EPISODIC_GAME runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_LOYALTY;

create or replace TABLE EPISODIC_GAME (
	PROGRAM_ID VARCHAR(16777216) NOT NULL COMMENT 'Albertson''s program identifier.',
	GAME_UUID VARCHAR(16777216) NOT NULL COMMENT 'Unique game identifier.',
	GAME_NM VARCHAR(16777216) COMMENT 'Game name.',
	...
	primary key (PROGRAM_ID, GAME_UUID, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
