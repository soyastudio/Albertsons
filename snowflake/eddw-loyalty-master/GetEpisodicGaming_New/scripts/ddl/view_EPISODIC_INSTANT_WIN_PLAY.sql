...
--changeset SYSTEM:EPISODIC_INSTANT_WIN_PLAY runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view EPISODIC_INSTANT_WIN_PLAY(
	PROGRAM_ID COMMENT 'Albertsons program identifier.',
	PLAY_ID COMMENT 'Unique identifier.',
	HOUSEHOLD_ID COMMENT 'Household ID.',
	GAME_UUID COMMENT 'Game played.',
	PLAY_DT COMMENT 'The Time of game play.',
...
) COMMENT='VIEW for Episodic_Instant_Win_Play'
 as
select
Program_Id,           
Play_Id,              
...
from EDM_CONFIRMED_PRD.DW_C_LOYALTY.Episodic_Instant_Win_Play;
