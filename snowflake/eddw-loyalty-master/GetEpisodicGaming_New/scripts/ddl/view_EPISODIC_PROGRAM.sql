...
--changeset SYSTEM:EPISODIC_PROGRAM runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view EPISODIC_PROGRAM(
	PROGRAM_ID COMMENT 'Unique program id.',
	PROGRAM_NM COMMENT 'Program Name.',
	PROGRAM_LABEL_NM COMMENT 'Program Label Name.',
	MERKLE_PROMO_ID COMMENT 'Merkes internal promotion id.',
	START_DT COMMENT 'The start date of the program.',
	END_DT COMMENT 'The end date of the program.',
...
) COMMENT='VIEW for Episodic_Program'
 as
select
Program_Id,
Program_Nm,
...
from EDM_CONFIRMED_PRD.DW_C_LOYALTY.Episodic_Program;
