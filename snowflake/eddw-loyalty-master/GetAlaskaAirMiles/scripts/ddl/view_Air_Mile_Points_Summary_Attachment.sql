...
--changeset SYSTEM:Air_Mile_Points_Summary_Attachment runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view AIR_MILE_POINTS_SUMMARY_ATTACHMENT(
...
) COMMENT='VIEW for Air_Mile_Points_Summary_Attachment'
 as
select
Batch_Id,
File_Nm,
...
from  <<EDM_DB_NAME>>.DW_C_LOYALTY.Air_Mile_Points_Summary_Attachment;
