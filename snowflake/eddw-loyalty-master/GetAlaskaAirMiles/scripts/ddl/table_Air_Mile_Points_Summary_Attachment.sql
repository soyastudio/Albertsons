...
--changeset SYSTEM:Air_Mile_Points_Summary_Attachment runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_LOYALTY;

create or replace TABLE AIR_MILE_POINTS_SUMMARY_ATTACHMENT (
	...
	primary key (BATCH_ID, FILE_NM, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
