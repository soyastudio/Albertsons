...
--changeset SYSTEM:SP_StoreGroup_To_Analytical_LOAD runOnChange:true splitStatements:false OBJECT_TYPE:SP
use database EDM_ANALYTICS_PRD;
use schema DW_RETAIL_EXP;

CREATE OR REPLACE PROCEDURE EDM_ANALYTICS_PRD.DW_RETAIL_EXP.SP_STOREGROUP_TO_ANALYTICAL_LOAD()
RETURNS STRING
LANGUAGE JAVASCRIPT
AS
$$
    ...
    var src_tbl = cnf_db + "." + dw_prd_schema + ".StoreGroup_Flat_C_STREAM";
    var src_rerun_tbl = anl_db + "." + wrk_schema + ".StoreGroup_Flat_anl_Rerun";
    var src_wrk_tbl = anl_db + "." + wrk_schema + ".StoreGroup_Flat_Fact_WRK";
	...
	var sub_proc_nm = 'SP_StoreGroup_To_Analytical_Load_Fact_Offer_Request';
    var params = "'"+ src_wrk_tbl + "','" + anl_db + "','" + anl_schema + "','" + wrk_schema + "','" + cnf_db + "','" + dw_prd_schema + "','" + dw_loc_schema + "'";
