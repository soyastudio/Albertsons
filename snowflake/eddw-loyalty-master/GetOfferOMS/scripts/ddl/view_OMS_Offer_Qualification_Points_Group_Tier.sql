...
--changeset SYSTEM:OMS_Offer_Qualification_Points_Group_Tier runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view OMS_OFFER_QUALIFICATION_POINTS_GROUP_TIER(
...
) COMMENT='VIEW for OMS_Offer_Qualification_Points_Group_Tier'
 as SELECT
 OMS_Offer_Id           ,
 Points_Group_Id        ,
 Tier_Level_Nbr         ,
 ...
 DW_SOURCE_UPDATE_NM     
FROM <<EDM_DB_NAME>>.DW_C_PRODUCT.OMS_Offer_Qualification_Points_Group_Tier;
