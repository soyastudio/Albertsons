...
--changeset SYSTEM:OMS_Offer_Qualification_Points_Group runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_PRODUCT;

create or replace TABLE OMS_OFFER_QUALIFICATION_POINTS_GROUP (
	...
	POINTS_GROUP_NM VARCHAR(16777216) COMMENT 'Points Group Number',
	POINTS_GROUP_VALUE_AMT NUMBER(38,3) COMMENT 'Points Group value Amount',
	...
	primary key (OMS_OFFER_ID, POINTS_GROUP_ID, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
