...
--changeset SYSTEM:OMS_Offer_Benefit_Points_Tier runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view OMS_OFFER_BENEFIT_POINTS_TIER(
	OMS_OFFER_ID COMMENT 'OMS Offer',
	POINTS_PROGRAM_ID COMMENT 'Point program',
	POINTS_TIER_ID COMMENT 'Point tier',
	DW_FIRST_EFFECTIVE_DT COMMENT 'First effective Date',
	DW_LAST_EFFECTIVE_DT COMMENT 'Last effective Date',
	POINTS_TIER_LEVEL_NBR COMMENT 'Point tier level nbr',
	POINTS_TIER_LEVEL_QTY COMMENT 'Point tier level qty',
...
) COMMENT='VIEW for OMS_Offer_Benefit_Points_Tier'
 as 
SELECT
 OMS_Offer_Id           ,
 Points_Program_Id      ,
 ...
 DW_SOURCE_UPDATE_NM     
 FROM <<EDM_DB_NAME>>.DW_C_PRODUCT.OMS_Offer_Benefit_Points_Tier;
