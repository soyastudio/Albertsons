...
--changeset SYSTEM:OMS_Offer_Benefit runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_PRODUCT;

create or replace TABLE OMS_OFFER_BENEFIT (
	...
	BENEFIT_VALUE_AMT NUMBER(38,3) COMMENT 'Benefit Value Amt',
	CUSTOMER_GROUP_ID NUMBER(38,0) COMMENT 'Customer Group Id',
	CUSTOMER_GROUP_NM VARCHAR(16777216) COMMENT 'Customer Group Nm',
