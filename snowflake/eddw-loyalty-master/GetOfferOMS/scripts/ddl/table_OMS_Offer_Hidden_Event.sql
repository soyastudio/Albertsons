...
--changeset SYSTEM:OMS_Offer_Hidden_Event runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_PRODUCT;

create or replace TABLE OMS_OFFER_HIDDEN_EVENT (
	OMS_OFFER_ID NUMBER(38,0) NOT NULL COMMENT 'OMS Offer Id',
	OMS_OFFER_HIDDEN_EVENT_CD VARCHAR(16777216) NOT NULL COMMENT 'OMS Offer Hidden Event Cd',
	...
	OMS_OFFER_EVENT_DESCRIPTION_TXT VARCHAR(16777216) COMMENT 'OMS Offer Event Description Txt',
	...
	primary key (OMS_OFFER_ID, OMS_OFFER_HIDDEN_EVENT_CD, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
