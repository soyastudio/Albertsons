...
--changeset SYSTEM:OMS_Offer_Terminal runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view OMS_OFFER_TERMINAL(
	OMS_OFFER_ID COMMENT 'OMS Offer',
	TERMINAL_NUMBER_TXT COMMENT 'Terminal values',
...
) COMMENT='VIEW for OMS_Offer_Terminal'
 as SELECT
 OMS_Offer_Id           ,
 Terminal_Number_Txt     ,
 ...
 DW_SOURCE_UPDATE_NM     
FROM <<EDM_DB_NAME>>.DW_C_PRODUCT.OMS_Offer_Terminal;
