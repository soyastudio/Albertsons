...
--changeset SYSTEM:OMS_Offer_Postal_Code runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_PRODUCT;

create or replace TABLE OMS_OFFER_POSTAL_CODE (
	OMS_OFFER_ID NUMBER(38,0) NOT NULL COMMENT 'OMS Offer ID',
	POSTAL_CD NUMBER(38,0) NOT NULL COMMENT 'Postal Code',
	...
	primary key (OMS_OFFER_ID, POSTAL_CD, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
