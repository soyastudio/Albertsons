...
--changeset SYSTEM:OMS_Offer_Terminal runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_PRODUCT;

create or replace TABLE OMS_OFFER_TERMINAL (
	OMS_OFFER_ID NUMBER(38,0) NOT NULL COMMENT 'OMS Offer ID',
	TERMINAL_NUMBER_TXT VARCHAR(16777216) NOT NULL COMMENT 'Terminal number Text',
