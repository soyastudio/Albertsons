...
--changeset SYSTEM:OMS_Offer_Qualification_Product_Group_Tier runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view OMS_OFFER_QUALIFICATION_PRODUCT_GROUP_TIER(
	OMS_OFFER_ID COMMENT 'OMS Offer',
	PRODUCT_GROUP_ID COMMENT 'Product group',
	TIER_LEVEL_NBR COMMENT 'Tier level',
	DW_FIRST_EFFECTIVE_DT COMMENT 'First effective Date',
	DW_LAST_EFFECTIVE_DT COMMENT 'Last effective Date',
	TIER_AMT COMMENT 'Amount for each tier',
...
) COMMENT='VIEW for OMS_Offer_Qualification_Product_Group_Tier'
 as SELECT
 OMS_Offer_Id           ,
 Product_Group_Id       ,
 Tier_Level_Nbr         ,
 ...
 DW_SOURCE_UPDATE_NM     
FROM <<EDM_DB_NAME>>.DW_C_PRODUCT.OMS_Offer_Qualification_Product_Group_Tier;
