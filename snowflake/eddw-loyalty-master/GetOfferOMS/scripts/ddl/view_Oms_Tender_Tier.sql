...
--changeset SYSTEM:Oms_Tender_Tier runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view OMS_TENDER_TIER(
	OMS_OFFER_ID COMMENT 'OMS Offer',
	TENDER_TYPE_DSC COMMENT 'TenderType Is a Payment Method',
	TIER_LEVEL_NBR COMMENT 'Since it is coming under conditions in OMS we are saying it as level 1',
	...
	TIER_VALUE_NBR COMMENT 'value entered by the user. It is an integer',
...
) COMMENT='View For Oms_Tender_Tier'
 as
Select
Oms_Offer_Id  ,
Tender_Type_Dsc  ,
...
From <<EDM_DB_NAME>>.DW_C_PRODUCT.Oms_Tender_Tier;
