...
--changeset SYSTEM:OMS_Offer_Event runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view OMS_OFFER_EVENT(
	OMS_OFFER_ID COMMENT 'OMS Offer',
	OMS_OFFER_EVENT_CD COMMENT 'Event cd',
...
) COMMENT='VIEW for OMS_Offer_Event'
 as 
SELECT
 OMS_Offer_Id           ,
 OMS_Offer_Event_Cd     ,
 ...
 DW_SOURCE_UPDATE_NM     
FROM <<EDM_DB_NAME>>.DW_C_PRODUCT.OMS_Offer_Event;
