...
--changeset SYSTEM:OMS_Offer_Qualification_Attribute runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view OMS_OFFER_QUALIFICATION_ATTRIBUTE(
	OMS_OFFER_ID COMMENT 'OMS Offer',
	QUALIFICATION_ATTRIBUTE_TYPE_TXT COMMENT 'Qualification_Attribute_Type_Txt',
	DW_FIRST_EFFECTIVE_DT COMMENT 'First effective Date',
	DW_LAST_EFFECTIVE_DT COMMENT 'Last effective Date',
	ATTRIBUTE_COMBO_TXT COMMENT 'Attribute combo',
...
) COMMENT='VIEW for OMS_Offer_Qualification_Attribute'
 as SELECT
 OMS_Offer_Id           ,
 ...
 DW_SOURCE_UPDATE_NM     
FROM <<EDM_DB_NAME>>.DW_C_PRODUCT.OMS_Offer_Qualification_Attribute;
