...
--changeset SYSTEM:OMS_Offer_Nopa_Numbers runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_PRODUCT;

create or replace TABLE OMS_OFFER_NOPA_NUMBERS (
	OMS_OFFER_ID NUMBER(38,0) NOT NULL COMMENT 'OMS Offer Id',
	NOPA_SEQUENCE_ID NUMBER(38,0) NOT NULL COMMENT 'Nopa Sequence Id',
	...
	NOPA_SEQUENCE_NUMBER_TXT VARCHAR(16777216) COMMENT 'Nopa Sequence Number Txt',
	...
	primary key (OMS_OFFER_ID, NOPA_SEQUENCE_ID, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
