...
--changeset SYSTEM:OMS_Offer_Redemption_Store_Group runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view OMS_OFFER_REDEMPTION_STORE_GROUP(
	OMS_OFFER_ID COMMENT 'OMS Offer',
	STORE_GROUP_ID COMMENT 'Store group id',
...
) COMMENT='VIEW for OMS_Offer_Redemption_Store_Group'
 as 
SELECT
 OMS_Offer_Id           ,
 Store_Group_Id         ,
 ...
 DW_SOURCE_UPDATE_NM     
FROM >>EDM_DB_NAME>>.DW_C_PRODUCT.OMS_Offer_Redemption_Store_Group;
