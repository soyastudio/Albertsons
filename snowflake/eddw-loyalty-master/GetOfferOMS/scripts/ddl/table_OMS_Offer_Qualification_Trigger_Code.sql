...
--changeset SYSTEM:OMS_Offer_Qualification_Trigger_Code runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_PRODUCT;

create or replace TABLE OMS_OFFER_QUALIFICATION_TRIGGER_CODE (
	OMS_OFFER_ID NUMBER(38,0) NOT NULL COMMENT 'OMS Offer ID',
	QUALIFICATION_TRIGGER_CD VARCHAR(16777216) NOT NULL COMMENT 'Qualification Trigger Code',
	...
	DISPLAY_CASHIER_MESSAGE_IF_UNUSED_IND BOOLEAN COMMENT 'Display cashier Message If Unused Indicator',
	REQUIREMENT_TXT VARCHAR(16777216) COMMENT 'Requirement Indicator',
	...
	primary key (OMS_OFFER_ID, QUALIFICATION_TRIGGER_CD, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
