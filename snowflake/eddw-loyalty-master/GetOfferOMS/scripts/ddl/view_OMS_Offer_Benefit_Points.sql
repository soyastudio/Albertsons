...
--changeset SYSTEM:OMS_Offer_Benefit_Points runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view OMS_OFFER_BENEFIT_POINTS(
	OMS_OFFER_ID COMMENT 'OMS Offer',
	POINTS_PROGRAM_ID COMMENT 'Point program id',
	DW_FIRST_EFFECTIVE_DT COMMENT 'First effective Date',
	DW_LAST_EFFECTIVE_DT COMMENT 'Last effective Date',
	POINTS_PROGRAM_NM COMMENT 'Point program name',
	SCORECARD_NM COMMENT 'Scorecard name',
	SCORECARD_TXT COMMENT ' Scorecard desc',
...
) COMMENT='VIEW for OMS_Offer_Benefit_Points'
 as 
SELECT
 OMS_Offer_Id           ,
 Points_Program_Id      ,
 ...
 DW_SOURCE_UPDATE_NM     
 FROM <<EDM_DB_NAME>>.DW_C_PRODUCT.OMS_Offer_Benefit_Points;
