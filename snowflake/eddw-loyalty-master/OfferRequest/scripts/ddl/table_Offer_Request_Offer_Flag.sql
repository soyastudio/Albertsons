...
--changeset SYSTEM:Offer_Request_Offer_Flag runOnChange:true splitStatements:false OBJECT_TYPE:TABLE

use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_PURCHASING;

create or replace TABLE OFFER_REQUEST_OFFER_FLAG (
	...
	primary key (OFFER_REQUEST_ID, OFFER_FLAG_DSC, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
