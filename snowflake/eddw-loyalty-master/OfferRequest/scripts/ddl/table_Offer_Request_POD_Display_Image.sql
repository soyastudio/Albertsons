...
--changeset SYSTEM:Offer_Request_POD_Display_Image runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_PURCHASING;

create or replace TABLE OFFER_REQUEST_POD_DISPLAY_IMAGE (
	OFFER_REQUEST_ID NUMBER(38,0) NOT NULL,
	USER_INTERFACE_UNIQUE_ID NUMBER(38,0) NOT NULL,
	POD_IMAGE_TYPE_CD VARCHAR(250) NOT NULL,
	DW_FIRST_EFFECTIVE_DT DATE NOT NULL,
	DW_LAST_EFFECTIVE_DT DATE NOT NULL,
	POD_IMAGE_ID VARCHAR(50),
...
)COMMENT='details of the images to be displayed on POD like mobile device for the offer. IVIE image or Scene7 image'
;
