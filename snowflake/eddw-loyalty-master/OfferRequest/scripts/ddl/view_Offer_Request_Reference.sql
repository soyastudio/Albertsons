...
--changeset SYSTEM:Offer_Request_Reference runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database EDM_VIEWS_PRD;
use schema EDM_VIEWS_PRD.DW_VIEWS;

create or replace view OFFER_REQUEST_REFERENCE(
	OFFER_REQUEST_ID COMMENT 'Offer_Request_Id',
	OFFER_REQUEST_REFERENCE_ID COMMENT 'Offer_Request_Reference_Id ',
...
) COMMENT='View For Offer_Request_Reference'
 as
Select
  Offer_Request_Id ,
...
From EDM_CONFIRMED_PRD.DW_C_PURCHASING.Offer_Request_Reference;