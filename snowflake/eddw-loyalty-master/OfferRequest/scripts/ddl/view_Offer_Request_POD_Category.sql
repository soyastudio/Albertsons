...
--changeset SYSTEM:Offer_Request_POD_Category runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database EDM_VIEWS_PRD;
use schema EDM_VIEWS_PRD.DW_VIEWS;

create or replace view OFFER_REQUEST_POD_CATEGORY(
	OFFER_REQUEST_ID COMMENT 'Offer_Request_Id',
	USER_INTERFACE_UNIQUE_ID COMMENT 'User_Interface_Unique_Id',
	POD_CATEGORY_CD COMMENT 'POD_Category_Cd',
	DW_FIRST_EFFECTIVE_DT COMMENT 'DW_First_Effective_Dt',
	DW_LAST_EFFECTIVE_DT COMMENT 'DW_Last_Effective_Dt',
	POD_CATEGORY_DSC COMMENT 'POD_Category_Dsc',
	POD_CATEGORY_SHORT_DSC COMMENT 'POD_Category_Short_Dsc',
...
) COMMENT='View For Offer_Request_POD_Category'
 as
SELECT 
Offer_Request_Id ,
...
FROM EDM_CONFIRMED_PRD.DW_C_PURCHASING.Offer_Request_POD_Category;