...
--changeset SYSTEM:Offer_Request_Offer_Flag runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database EDM_VIEWS_PRD;
use schema EDM_VIEWS_PRD.DW_VIEWS;

create or replace view OFFER_REQUEST_OFFER_FLAG(
...
) COMMENT='View For Offer_Request_Offer_Flag'
 as
Select
Offer_Request_Id      ,
Offer_Flag_Dsc   ,
...
From EDM_CONFIRMED_PRD.DW_C_PURCHASING.Offer_Request_Offer_Flag;