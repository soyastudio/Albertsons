...
--changeset SYSTEM:Offer_Request_Sub_Group runOnChange:true splitStatements:false OBJECT_TYPE:TABLE

use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_PURCHASING;

create or replace TABLE OFFER_REQUEST_SUB_GROUP (
	GROUP_ID VARCHAR(10) NOT NULL,
	SUB_GROUP_ID VARCHAR(10) NOT NULL,
	...
	primary key (GROUP_ID, SUB_GROUP_ID, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT, OFFER_REQUEST_ID)
);
