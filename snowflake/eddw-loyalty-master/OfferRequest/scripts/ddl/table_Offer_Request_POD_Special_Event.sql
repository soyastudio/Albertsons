...
--changeset SYSTEM:Offer_Request_POD_Special_Event runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_PURCHASING;

create or replace TABLE OFFER_REQUEST_POD_SPECIAL_EVENT (
	OFFER_REQUEST_ID NUMBER(38,0) NOT NULL,
	USER_INTERFACE_UNIQUE_ID NUMBER(38,0) NOT NULL,
	POD_EVENT_ID VARCHAR(20) NOT NULL,
	DW_FIRST_EFFECTIVE_DT DATE NOT NULL,
	DW_LAST_EFFECTIVE_DT DATE NOT NULL,
	POD_EVENT_NM VARCHAR(100),
...
)COMMENT='special events like $5 friday or weekend savings or pizza night..etc'
;
