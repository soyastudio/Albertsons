...
--changeset SYSTEM:FRESHPASS_SUBSCRIPTION_BENEFIT runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view FRESHPASS_SUBSCRIPTION_BENEFIT(
	...
	BENEFIT_TYPE_DSC COMMENT 'Description of the subscription event',
...
) COMMENT='VIEW For Freshpass_Subscription_Benefit'
 as
SELECT 
...
FROM EDM_CONFIRMED_PRD.DW_C_LOYALTY.FRESHPASS_SUBSCRIPTION_BENEFIT;
