...
--changeset SYSTEM:FRESHPASS_SUBSCRIPTION_BENEFIT runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_LOYALTY;

create or replace TABLE FRESHPASS_SUBSCRIPTION_BENEFIT (
	...
	BENEFIT_TYPE_DSC VARCHAR(16777216) NOT NULL COMMENT 'Description of the subscription event',
	...
	constraint XPKFRESHPASS_SUBSCRIPTION_DISCOUNT primary key (RETAIL_CUSTOMER_UUID, EVENT_ID, SUBSCRIPTION_PLAN_INTEGRATION_ID, BENEFIT_TYPE_DSC, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
