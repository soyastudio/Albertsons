...
--changeset SYSTEM:CUSTOMER_SESSION_IMPRESSION runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database EDM_CONFIRMED_<<ENV>>;
use schema DW_C_USER_ACTIVITY;

CREATE OR REPLACE TABLE EDM_CONFIRMED_<<ENV>>.DW_C_USER_ACTIVITY.CUSTOMER_SESSION_IMPRESSION
(
	...
	primary key (EVENT_ID,EVENT_TS,BASE_PRODUCT_NBR)
