...
--changeset SYSTEM:CUSTOMER_SESSION_OPERATING_SYSTEM_WRK runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database EDM_CONFIRMED_<<ENV>>;
use schema DW_C_STAGE;

create TRANSIENT TABLE CUSTOMER_SESSION_OPERATING_SYSTEM_WRK (
