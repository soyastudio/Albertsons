...
--changeset SYSTEM:ONE_TAG_CAROUSEL_FLAT_WRK runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database EDM_REFINED_<<ENV>>;
use schema DW_R_STAGE;

CREATE OR REPLACE TRANSIENT TABLE ONE_TAG_CAROUSEL_FLAT_WRK
(	event_hr   NUMBER
,   event_id	VARCHAR
