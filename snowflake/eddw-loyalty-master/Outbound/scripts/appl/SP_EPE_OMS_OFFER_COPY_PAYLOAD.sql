...
--changeset SYSTEM:SP_EPE_OMS_OFFER_COPY_PAYLOAD runOnChange:true splitStatements:false OBJECT_TYPE:SP
use database EDM_CONFIRMED_OUT_PRD;
use schema DW_APPL;

CREATE OR REPLACE PROCEDURE EDM_CONFIRMED_OUT_PRD.DW_APPL.SP_EPE_OMS_OFFER_COPY_PAYLOAD()
RETURNS STRING
LANGUAGE JAVASCRIPT
AS
$$
...
var src_schema = "DW_APPL";
var src_tbl = src_db + "." + src_schema + ".EPE_OMS_OFFER_JSON_O_STREAM";
var src_wrk_tbl = cnf_out_db + "." + wrk_schema + ".EPE_OMS_OFFER_JSON_WRK";
var src_rerun_tbl = cnf_out_db + "." + wrk_schema + ".EPE_OMS_OFFER_JSON_RERUN";
var kafka = cnf_out_db + "." + cnf_out_schema + ".KAFKAOUTQUEUE";
var audit_table = cnf_out_db + "." + cnf_out_schema + ".EPE_OFFER_JSON_AUDIT";
    
    var azure_future = "@EDDW_EPE_STAGE_OUTBOUND/epe_oms_offers";
    ...
    var sql_crt_src_wrk_tbl = `CREATE OR REPLACE TABLE `+ src_wrk_tbl +` 
    ...
    var filter_copy_future = " ";
    var filter_copy_today = " ";
    var filter_copy_current = " ";
    var filter_copy_past = " ";
