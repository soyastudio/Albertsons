...
--changeset SYSTEM:EPISODIC_DRAWING runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_LOYALTY;

create or replace TABLE EPISODIC_DRAWING (
	PROGRAM_ID VARCHAR(16777216) NOT NULL COMMENT 'Albertson''s program identifier.',
	DRAWING_ID VARCHAR(16777216) NOT NULL COMMENT 'Unique drawing identifier.',
	GAME_UUID VARCHAR(16777216) COMMENT 'Unique game identifier.',
	GAME_TYPE_CD VARCHAR(16777216) COMMENT 'Game Type.',
	START_DT TIMESTAMP_LTZ(9) COMMENT 'The start date of this drawing.',
	END_DT TIMESTAMP_LTZ(9) COMMENT 'The end date of this drawing.',
	DRAW_DT TIMESTAMP_LTZ(9) COMMENT 'The Time when the winner will be determined.',
	...
	primary key (PROGRAM_ID, DRAWING_ID, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
