...
--changeset SYSTEM:EPISODIC_PROFILE_FLAT runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME_R>>;
use schema <<EDM_DB_NAME_R>>.DW_R_LOYALTY;

create or replace TABLE EPISODIC_PROFILE_FLAT (
	HOUSEHOLD_ID VARCHAR(16777216),
	PROFILE_ID VARCHAR(16777216),
	REGISTRATION_DATE VARCHAR(16777216),
	RULES_ACCEPTED_TS VARCHAR(16777216),
