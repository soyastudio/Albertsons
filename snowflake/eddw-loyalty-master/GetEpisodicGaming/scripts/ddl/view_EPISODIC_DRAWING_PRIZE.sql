...
--changeset SYSTEM:EPISODIC_DRAWING_PRIZE runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view EPISODIC_DRAWING_PRIZE(
	...
	DW_LAST_UPDATE_TS COMMENT 'When a record i',
...
) COMMENT='VIEW for Episodic_Drawing_Prize'
 as
select
Program_Id,
Drawing_Id,
...
from EDM_CONFIRMED_PRD.DW_C_LOYALTY.Episodic_Drawing_Prize;
