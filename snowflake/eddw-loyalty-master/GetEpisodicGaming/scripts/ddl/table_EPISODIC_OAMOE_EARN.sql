...
--changeset SYSTEM:EPISODIC_OAMOE_EARN runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_LOYALTY;

create or replace TABLE EPISODIC_OAMOE_EARN (
	PROGRAM_ID VARCHAR(16777216) NOT NULL COMMENT 'Albertson''s program identifier.',
	OAMOE_ID NUMBER(38,0) NOT NULL COMMENT 'Unique identifier.',
	HOUSEHOLD_ID NUMBER(38,0) COMMENT 'Household ID.',
	ACTION_CD VARCHAR(16777216) COMMENT 'Action.',
	PLAY_EARNED_NBR NUMBER(38,0) COMMENT 'The Number of plays earned.',
	...
	primary key (PROGRAM_ID, OAMOE_ID, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
