...
--changeset SYSTEM:EPISODIC_SELECTION runOnChange:true splitStatements:false OBJECT_TYPE:VIEW
use database <<EDM_VIEW_NAME>>;
use schema <<EDM_VIEW_NAME>>.DW_VIEWS;

create or replace view EPISODIC_SELECTION(
	PROGRAM_ID COMMENT 'Albertson''s program identifier.',
	SELECT_ID COMMENT 'Unique select action identifier.',
	HOUSEHOLD_ID COMMENT 'Household ID.',
	ACTION_CD COMMENT 'Action.',
	RETAIL_STORE_ID COMMENT 'The store ID.',
	REFERENCE_ID COMMENT 'The selected item reference id.',
	BANNER_NM COMMENT 'The Banner where action occurred.',
	CREATED_TS COMMENT 'The timestamp the record was inserted.',
...
) COMMENT='VIEW for Episodic_Selection'
 as
select
Program_Id,
Select_Id,
...
from EDM_CONFIRMED_PRD.DW_C_LOYALTY.Episodic_Selection;
