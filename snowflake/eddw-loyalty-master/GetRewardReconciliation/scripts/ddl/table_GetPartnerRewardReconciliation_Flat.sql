...
--changeset SYSTEM:GetPartnerRewardReconciliation_Flat runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME_R>>;
use schema <<EDM_DB_NAME_R>>.DW_R_LOYALTY;

create or replace TABLE GETPARTNERREWARDRECONCILIATION_FLAT (
