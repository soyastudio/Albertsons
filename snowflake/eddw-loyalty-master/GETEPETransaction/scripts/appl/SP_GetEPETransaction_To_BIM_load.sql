...
--changeset SYSTEM:SP_GetEPETransaction_To_BIM_load runOnChange:true splitStatements:false OBJECT_TYPE:SP
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_APPL;

CREATE OR REPLACE PROCEDURE <<EDM_DB_NAME>>.DW_APPL.SP_GETEPETRANSACTION_TO_BIM_LOAD()
RETURNS STRING
LANGUAGE JAVASCRIPT
AS
$$
...
var sub_proc_nms = ['SP_GetEPETransaction_To_BIM_EPE_Transaction_Header'
					  ,'SP_GetEPETransaction_To_BIM_EPE_Transaction_Item_External_Savings'
					  ,'SP_GetEPETransaction_To_BIM_load_EPE_Transaction_Card_Savings'
					  ,'SP_GetEPETransaction_To_BIM_load_EPE_Transaction_Error'
					  ,'SP_GetEPETransaction_To_BIM_load_EPE_Transaction_Header_Savings'
					  ,'SP_GetEPETransaction_To_BIM_load_EPE_TRANSACTION_ITEM'
					  ,'SP_GetEPETransaction_To_BIM_load_EPE_Transaction_Item_Savings'
					  ,'SP_GetEPETransaction_To_BIM_load_EPE_Transaction_Usage'
					  ,'SP_GetEPETransaction_To_BIM_load_EPE_Transaction_Header_Saving_Points'
                      ,'SP_GetEPETransaction_To_BIM_EPE_Transaction_Header_Saving_Clips'
                      ,'SP_GETEPETRANSACTION_TO_BIM_LOAD_EPE_Transaction_Item_Saving_Clips'
					  ]
    ...
    var src_tbl = `${ref_db}.${app_schema}.GetEPETransaction_Flat_R_Stream`;
	var src_rerun_tbl = `${ref_db}.${wrk_schema}.GetEPETransaction_Flat_Rerun`;
    var src_wrk_tbl = `${ref_db}.${wrk_schema}.GetEPETransaction_Flat_wrk`;
