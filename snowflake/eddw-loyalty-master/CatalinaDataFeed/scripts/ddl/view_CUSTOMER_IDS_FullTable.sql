...
CREATE OR REPLACE SECURE VIEW <<TGT_EDM_DB_NAME>>.<<VW_DEPLOY_SCHEMA>>.CUSTOMER_IDS_FULLTABLE COPY GRANTS as
select  
...
where TH.TRANSACTION_DT BETWEEN TO_DATE('2022-07-01') AND TO_DATE('2023-02-28') AND RS.DW_LOGICAL_DELETE_IND = FALSE;
