...
--changeset SYSTEM:CLICK_STREAM_SEARCH_ENGINE runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database EDM_CONFIRMED_PRD;
use schema DW_C_USER_ACTIVITY;

create or replace TABLE CLICK_STREAM_SEARCH_ENGINE (
	SEARCH_ENGINE_NM VARCHAR(250) NOT NULL COMMENT 'The Search Engine that referred the visitor to your site. Uses search_engines.tsv lookup.',
	...
	SEARCH_ENGINE_ID VARCHAR(50) COMMENT 'Numeric ID representing the Search Engine that referred the visitor to your site. Uses search_engines.tsv lookup.',
	...
	primary key (SEARCH_ENGINE_NM, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);