...
--changeset SYSTEM:CLICK_STREAM_CLICK_EVENT runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database EDM_CONFIRMED_PRD;
use schema DW_C_USER_ACTIVITY;

create or replace TABLE CLICK_STREAM_CLICK_EVENT (
	EVENT_NM VARCHAR(250) NOT NULL COMMENT 'Name of the event triggered on the hit. Includes both default events and custom events 1-1000. Uses event.tsv lookup.',
	...
	EVENT_ID VARCHAR(50) COMMENT 'Numeric ID representing the events triggered on the hit. Includes both default events and custom events 1-1000. References the browser.tsv lookup table.',
	...
	primary key (EVENT_NM, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);