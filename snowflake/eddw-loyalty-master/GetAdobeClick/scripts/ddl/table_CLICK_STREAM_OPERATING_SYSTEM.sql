...
create or replace TABLE CLICK_STREAM_OPERATING_SYSTEM (
	OPERATING_SYSTEM_NM VARCHAR(250) NOT NULL COMMENT 'Operating System Name and Version',
	...
	OPERATING_SYSTEM_ID VARCHAR(50) COMMENT 'Numeric ID representing the operating system of the visitor. Based on the user_agent column. Uses os lookup.',
	...
	primary key (OPERATING_SYSTEM_NM, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);