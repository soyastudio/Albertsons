...
,Operating_System_Id comment 'Numeric ID representing the operating system of the visitor. Based on the user_agent column. Uses os lookup.'
...
COPY GRANTS comment = 'View For Click_Stream_Operating_System' AS 
SELECT
 Operating_System_Nm
,Operating_System_Id
...
FROM 
EDM_CONFIRMED_PRD.DW_C_USER_ACTIVITY.Click_Stream_Operating_System;