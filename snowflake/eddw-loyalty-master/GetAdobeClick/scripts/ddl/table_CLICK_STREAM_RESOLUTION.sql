...
--changeset SYSTEM:CLICK_STREAM_RESOLUTION runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database EDM_CONFIRMED_PRD;
use schema DW_C_USER_ACTIVITY;

create or replace TABLE CLICK_STREAM_RESOLUTION (
	RESOLUTION_NM VARCHAR(250) NOT NULL COMMENT 'The resolution of the monitor. Used in the Monitor resolution dimension. Uses resolution.tsv lookup table.',
	...
	RESOLUTION_ID VARCHAR(50) COMMENT 'Numeric ID representing the resolution of the monitor. Used in the Monitor resolution dimension. Uses resolution.tsv lookup table',
	...
	primary key (RESOLUTION_NM, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);