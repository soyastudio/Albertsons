...
--changeset SYSTEM:CLICK_STREAM_LANGUAGE runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database EDM_CONFIRMED_PRD;
use schema DW_C_USER_ACTIVITY;

create or replace TABLE CLICK_STREAM_LANGUAGE (
	LANGUAGE_NM VARCHAR(250) NOT NULL COMMENT 'Numeric ID of language. Uses languages.tsv lookup table.',
	...
	LANGUAGE_ID VARCHAR(50) COMMENT 'Numeric ID of language. Uses languages.tsv lookup table.',
	...
	primary key (LANGUAGE_NM, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);