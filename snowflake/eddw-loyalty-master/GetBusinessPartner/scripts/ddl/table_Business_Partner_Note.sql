...
--changeset SYSTEM:Business_Partner_Note runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_LOYALTY;

create or replace TABLE BUSINESS_PARTNER_NOTE (
	...
	NOTES_TYPE_CD VARCHAR(30) NOT NULL COMMENT 'Notes_Type_Cd',
	...
	NOTES_TYPE_TXT VARCHAR(2000) COMMENT 'Notes_Type_Txt',
	...
	primary key (BUSINESS_PARTNER_INTEGRATION_ID, PARTNER_NM, NOTES_TYPE_CD, DW_FIRST_EFFECTIVE_DT, DW_LAST_EFFECTIVE_DT)
);
