...
--changeset SYSTEM:sp_GetCustomerRewardBalance_To_BIM_load runOnChange:true splitStatements:false OBJECT_TYPE:SP
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_APPL;

CREATE OR REPLACE PROCEDURE <<EDM_DB_NAME>>.DW_APPL.SP_GETCUSTOMERREWARDBALANCE_TO_BIM_LOAD()
RETURNS STRING
LANGUAGE JAVASCRIPT
AS
$$
    ...
    var sub_proc_nms = ['sp_GetCustomerRewardBalance_To_BIM_load_Customer_Reward_Balance',
	'SP_GetCustomerRewardBalance_To_BIM_Customer_Reward_ScoreCard',
	'SP_GetCustomerRewardBalance_To_BIM_Customer_Program_Scorecard']
    ...
    var src_tbl = `${ref_db}.${app_schema}.GetCustomerRewardBalance_Flat_R_STREAM`;
	var src_rerun_tbl = `${ref_db}.${wrk_schema}.GetCustomerRewardBalance_Flat_Rerun`;
    var src_wrk_tbl = `${ref_db}.${wrk_schema}.GetCustomerRewardBalance_Flat_wrk`;
