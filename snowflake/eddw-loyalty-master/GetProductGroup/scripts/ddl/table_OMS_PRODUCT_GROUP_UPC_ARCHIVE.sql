...
--changeset SYSTEM:OMS_PRODUCT_GROUP_UPC_ARCHIVE runOnChange:true splitStatements:false OBJECT_TYPE:TABLE
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_C_PRODUCT;


create or replace TABLE OMS_PRODUCT_GROUP_UPC_ARCHIVE (
	PRODUCT_GROUP_ID NUMBER(38,0) NOT NULL,
	UPC_CD VARCHAR(14) NOT NULL,
	...
	UPC_VERSION_TXT VARCHAR(16777216) COMMENT 'version number of the UPC',
	UPC_DSC VARCHAR(16777216) COMMENT 'UPC Description',
	LIST_TYPE_DSC VARCHAR(16777216) COMMENT 'Type Description of the UPC',
