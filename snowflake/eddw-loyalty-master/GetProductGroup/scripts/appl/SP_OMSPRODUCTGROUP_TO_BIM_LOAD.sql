...
--changeset SYSTEM:SP_OMSPRODUCTGROUP_TO_BIM_LOAD runOnChange:true splitStatements:false OBJECT_TYPE:SP
use database <<EDM_DB_NAME>>;
use schema <<EDM_DB_NAME>>.DW_APPL;

CREATE OR REPLACE PROCEDURE <<EDM_DB_NAME>>.DW_APPL.SP_OMSPRODUCTGROUP_TO_BIM_LOAD()
RETURNS STRING
LANGUAGE JAVASCRIPT
AS
$$
    ...
    var sub_proc_nms = ['sp_OMSProductGroup_To_BIM_load_OMS_Product_Group',  
	'sp_OMSProductGroup_To_BIM_load_OMS_Product_Group_Department_Section', 
	'sp_OMSProductGroup_To_BIM_load_OMS_Product_Group_UPC',             
	'sp_OMSProductGroup_To_BIM_load_OMS_Product_Group_UPC_Manufacturer',
	'sp_OMSProductGroup_To_BIM_load_OMS_Product_Group_UPC_Comment',
	'SP_OMSProductGroup_TO_BIM_LOAD_OMSOffer_Flat']
    ...
    try {
        ...
        var ref_schema = metaparams['R_PROD'];
    ...
    var src_tbl = `${ref_db}.${app_schema}.OMSProductGroup_Flat_R_STREAM`;
              var src_rerun_tbl = `${ref_db}.${wrk_schema}.OMSProductGroup_Flat_Rerun`;
    var src_wrk_tbl = `${ref_db}.${wrk_schema}.OMSProductGroup_Flat_wrk`;
